  ...
  private normalizeDefinition(definition: Partial<FormDefinition> | undefined | null, fallback?: Form): FormDefinition {
    ...
    return {
      ...
      theme: {
        ...
        formBackgroundColor: definition?.theme?.formBackgroundColor,
        formOpacity: definition?.theme?.formOpacity,
        formBackgroundImage: definition?.theme?.formBackgroundImage,
        formAnimation: definition?.theme?.formAnimation,
        formShadow: definition?.theme?.formShadow,
        formSaberEffect: definition?.theme?.formSaberEffect,
        formBorderColor: definition?.theme?.formBorderColor,
        formPadding: definition?.theme?.formPadding,
      },
      logicRules,
      actionsPipeline,
